...
function InnerIssue({
  ...
  return (
    <>
      ...
      <div className="content-issues-infoBlock row">
        <div className="issues-infoblock-box columm">
          <ul className="issues-markers row">
            <li className="row">
              <p className="issues-infoblock-txt">Type:</p>
              <p className={'issues-markers-item  marker-type-' + issue_type}>{issue_type}</p>
            </li>

            <li className="row">
              <p className="issues-infoblock-txt">Priority:</p>
              <p className={'issues-markers-item  marker-priority-' + priority}>{priority}</p>
            </li>

            <li className="row">
              <p className="issues-infoblock-txt">Status:</p>
          ...
          <div className="issues-infoblock-assignee row">
            <p className="issues-infoblock-txt">Assignee:</p>
          ...
          <div className="issues-infoblock-assignee row">
            <p className="issues-infoblock-txt">Reporter:</p>
        ...
        <div className="issues-infoblock-box columm">
          <div className="issues-infoblock-estimate row">
            Original estimate: <span>{original_estimate}h</span>{' '}
            <button className="issues-infoblock-edit"></button>
          </div>
      ...
      <h3 className="content-innerIssue-title">Linked issues +</h3>
      ...
      <h3 className="content-innerIssue-title">Attachments</h3>
      ...
      <h3 className="content-innerIssue-title">Description</h3>

      <p className="content-innerIssue-description">{description}</p>
    </>
  );
}
